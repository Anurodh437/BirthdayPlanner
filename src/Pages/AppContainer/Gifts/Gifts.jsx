...
const Gifts = () => {
  ...
  return (
    <div className="">
      ...
      <div id="gifts-section" className="antialiased down-bg text-white font-sans p-6">
        <h1 className="flex text-white justify-center text-3xl">Find Unique Presents and gifts, Here!</h1>
        <p className="flex text-white justify-center text-lg">The Best gifts at the best prices</p>
